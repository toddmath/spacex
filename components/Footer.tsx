        ...
        <>
          <div className='items-center grid-flow-col'>
            ...
            <address className='hidden'>
              {data.hq.address}
              <br />
              {data.hq.city},&nbsp;{data.hq.state}
            </address>
          </div>

          <div className='grid-flow-col gap-2 md:gap-4 place-self-center justify-self-end'>
            <a href={data.links.twitter} className='btn btn-link btn-sm md:btn-md'>
              <FiTwitter
                className='fill-current w-6 h-6'
                aria-label='spacex twitter'
              />
            </a>
            <a href={data.links.flickr} className='btn btn-link btn-sm md:btn-md'>
              <ImFlickr2
                className='fill-current w-6 h-6'
