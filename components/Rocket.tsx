...
const Rocket: React.FC<RocketProps> = ({ data }) => {
  ...
  return (
    ...
    >
      ...
      >
        <header className="rounded-t-box mx-auto w-full bg-gradient-to-b from-neutral/40 to-neutral/60 py-3 text-center text-neutral-content mix-blend-hard-light backdrop-blur-sm focus-visible:outline-none">
          <h3 className="m-0 p-0 text-center text-3xl font-bold uppercase text-neutral-content">
            {data.name}
          </h3>
        </header>

        <p className="rounded-b-box m-0 overflow-hidden bg-gradient-to-b from-neutral/60 to-neutral/80 px-6 pb-6 pt-3 text-neutral-content mix-blend-hard-light backdrop-blur-sm">
          {data.description}
        </p>
