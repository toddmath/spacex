...
These states also come with corresponding events such as `onPress` and `onHoverStart`. To use these events in your own custom components, see hooks such as [usePress](../interactions/usePress.md), [useHover](../interactions/useHover.md), [useMove](../interactions/useMove.md), and [useFocusRing](../interactions/useFocusRing.md).
