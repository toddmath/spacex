...
In this tutorial, we'll build a custom [Select](../components/Select.md) component.
...
React Aria works out of the box in any React framework. When you're ready, follow our [framework setup](./frameworks.md) guide to optimize the bundle size and configure internationalization. To integrate with a client side router, use the `render` prop as described in the [Link](../components/Link.md) docs.
